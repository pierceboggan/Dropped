...
- **specs/**: Folder containing feature specifications.
  ...
  - **ai-training-plan.md**: Specification for the AI training plan feature.
- **plans/**: Folder containing implementation plans.
  ...
  - **ai-training-plan.md**: Implementation plan for the AI training plan feature.
...
- **WorkoutDetailView.swift**: SwiftUI view displaying detailed information about a specific workout, including overview, intervals list, and power graph. Created as part of the workout detail feature. Accessible, supports light/dark mode, and is visually consistent with the app. Includes inline power/time graph visualization.
